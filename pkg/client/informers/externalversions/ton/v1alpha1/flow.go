	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TonV1alpha1().Flows(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TonV1alpha1().Flows(namespace).Watch(context.TODO(), options)
			},
		},
		&tonv1alpha1.Flow{},
		resyncPeriod,
...
func (f *flowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tonv1alpha1.Flow{}, f.defaultInformer)
}
