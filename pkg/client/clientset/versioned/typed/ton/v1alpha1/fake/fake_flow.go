...
var flowsResource = schema.GroupVersionResource{Group: "ton.k8s.io", Version: "v1alpha1", Resource: "flows"}

var flowsKind = schema.GroupVersionKind{Group: "ton.k8s.io", Version: "v1alpha1", Kind: "Flow"}

// Get takes name of the flow, and returns the corresponding flow object, and an error if there is any.
func (c *FakeFlows) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Flow, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlows) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FlowList, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlows) Create(ctx context.Context, flow *v1alpha1.Flow, opts v1.CreateOptions) (result *v1alpha1.Flow, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlows) Update(ctx context.Context, flow *v1alpha1.Flow, opts v1.UpdateOptions) (result *v1alpha1.Flow, err error) {
	obj, err := c.Fake.
...
func (c *FakeFlows) UpdateStatus(ctx context.Context, flow *v1alpha1.Flow, opts v1.UpdateOptions) (*v1alpha1.Flow, error) {
	obj, err := c.Fake.
...
func (c *FakeFlows) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Flow, err error) {
	obj, err := c.Fake.
